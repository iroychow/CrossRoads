...
public class UpcomingProductDB {
    ...
    public static int insert(Menu product) {
		...
		try{
        String preparedQuery =  "INSERT INTO upcomingproduct "
    ...
    public static int update(Menu product) {
       ...
       try {
            String preparedSQL = "UPDATE upcomingproduct SET "
                   + "   code = ?, " 
                   + "   description = ?, "
                   + "   price = ?"
                   + "WHERE code = ?";
    ...
    public static int delete(Menu product) {
        ...
        String query = "DELETE FROM upcomingproduct "
                + "WHERE code = ?";
        try {
    ...
    public static boolean codeExists(String code) {
        ...
        String query = "SELECT code FROM upcomingproduct "
                + "WHERE code= ?";
        try {
            ps = connection.prepareStatement(query);
            ps.setString(1, code);
    ...
    public static Menu selectProduct(String code) {
        ...
        String query = "SELECT * FROM upcomingproduct"
                + " WHERE code = ?";
        try {
            ps = connection.prepareStatement(query);
            ps.setString(1, code);
